...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased overflow-x-hidden bg-gradient-to-br from-violet-50 via-purple-50 to-indigo-50">
        <!-- 3D Canvas Background -->
        <canvas id="3d-canvas" class="fixed inset-0 w-full h-full -z-10"></canvas>
        ...
        <div class="relative min-h-screen">
            ...
            <nav class="relative z-10 p-6 lg:p-8">
                <div class="max-w-7xl mx-auto flex items-center justify-between">
                    <a href="{{ url('/') }}" class="flex items-center space-x-3 group">
                        ...
                        <div>
                            <span class="text-xl font-bold bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent block">
                                CCA
                            </span>
                        </div>
                    </a>
            ...
            <!-- Hero Section -->
            <div class="relative z-10 px-6 lg:px-8 py-12 lg:py-24">
                <div class="max-w-7xl mx-auto">
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        <!-- Left Column - Content -->
                        <div class="space-y-8">
                            <div class="inline-block mb-4">
                                <div class="p-6 rounded-2xl bg-white/60 backdrop-blur-lg border border-white/80 shadow-xl hover:shadow-2xl hover:bg-white/70 transition-all duration-300 inline-block">
                            ...
                            <div class="space-y-6">
                                ...
                                <p class="text-xl lg:text-2xl text-gray-600 leading-relaxed">
                                    Transform your future with industry-leading programs designed to fast-track your professional growth.
                                </p>
                            </div>

                            <div class="flex flex-wrap gap-4">
                                <a href="{{ route('cca.register') }}" 
                                   class="group px-8 py-4 rounded-2xl bg-gradient-to-r from-primary-500 to-secondary-500 
                            ...
                            <div class="grid grid-cols-3 gap-6 pt-8">
                                ...
                                <div class="text-center p-4 rounded-2xl bg-white/70 backdrop-blur-xl border border-white/90 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
                                    <div class="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent">100%</div>
                                    <div class="text-sm text-gray-700 mt-1 font-medium">Success Stories</div>
                                </div>
                                <div class="text-center p-4 rounded-2xl bg-white/70 backdrop-blur-xl border border-white/90 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
                                    <div class="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent">24/7</div>
                                    <div class="text-sm text-gray-700 mt-1 font-medium">Support</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative hidden lg:block">
                            <div class="space-y-6">
                                <!-- Feature Card 1 -->
                                <div class="group relative p-8 rounded-3xl bg-white/75 backdrop-blur-2xl border border-white/90 
                                    ...
                                    <div class="relative">
                                        ...
                                        <h3 class="text-xl font-bold text-gray-800 mb-2">Industry-Aligned Programs</h3>
                                        <p class="text-gray-700 leading-relaxed">Curated curriculum designed with industry experts to match real-world demands.</p>
                                    </div>
                                </div>
                                ...
                                <div class="group relative p-8 rounded-3xl bg-white/75 backdrop-blur-2xl border border-white/90 
                                    ...
                                    <div class="relative">
                                        ...
                                        <h3 class="text-xl font-bold text-gray-800 mb-2">Expert Mentorship</h3>
                                        <p class="text-gray-700 leading-relaxed">Learn from industry professionals with years of practical experience.</p>
                                    </div>
                                </div>
                                ...
                                <div class="group relative p-8 rounded-3xl bg-white/75 backdrop-blur-2xl border border-white/90 
                                    ...
                                    <div class="relative">
                                        ...
                                        <h3 class="text-xl font-bold text-gray-800 mb-2">Recognized Certification</h3>
                                        <p class="text-gray-700 leading-relaxed">Earn certifications valued by employers across the industry.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="contact" class="relative z-10 px-6 lg:px-8 py-20">
                <div class="max-w-6xl mx-auto">
                    <div class="text-center mb-12">
                        ...
                        <p class="text-xl text-gray-600">We're here to help you every step of the way</p>
                    </div>

                    <div class="grid md:grid-cols-2 gap-8 mb-12">
                        <!-- Contact Info Card -->
                        <div class="p-8 rounded-3xl bg-white/40 backdrop-blur-lg border border-white/70 shadow-xl">
                            <h3 class="text-2xl font-bold text-gray-800 mb-6">Contact Information</h3>
                            <div class="space-y-4">
                                <div class="flex items-start gap-4">
                                    <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-primary-500 to-secondary-500 flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-1">
                                            <a href="mailto:ca@codezela.com" class="text-primary-600 hover:text-primary-700 block">ca@codezela.com</a>
                                            <a href="mailto:shamal@codezela.com" class="text-primary-600 hover:text-primary-700 block">shamal@codezela.com</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-800">Phone / WhatsApp</p>
                                        <div class="space-y-1">
                                            <a href="tel:+94766772923" class="text-primary-600 hover:text-primary-700 block">+94 76 677 2923</a>
                                            <a href="tel:+94766778438" class="text-primary-600 hover:text-primary-700 block">+94 76 677 8438</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-800">Support Hours</p>
                        ...
                        <div class="p-8 rounded-3xl bg-white/40 backdrop-blur-lg border border-white/70 shadow-xl">
                            ...
                            <div class="space-y-4">
                                <a href="{{ route('cca.register') }}" 
                                   class="flex items-center gap-4 p-4 rounded-2xl bg-gradient-to-r from-primary-500 to-secondary-500 
                                    ...
                                    <div class="flex-1 text-left">
                                        <p class="font-semibold">Start Registration</p>
                                        <p class="text-sm opacity-90">Fill out the registration form</p>
                                    </div>
                                    <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <a href="https://wa.me/94766772923" target="_blank"
                                   class="flex items-center gap-4 p-4 rounded-2xl bg-white/60 backdrop-blur-md border border-white/80 
                                    ...
                                    <div class="flex-1 text-left">
                                        ...
                                        <p class="text-sm text-gray-600">Chat with us instantly</p>
                                    </div>
                                    <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                                    </svg>
                    ...
                    <!-- Social Media -->
                    <div class="text-center p-8 rounded-3xl bg-white/40 backdrop-blur-lg border border-white/70 shadow-xl">
                        <h3 class="text-xl font-bold text-gray-800 mb-6">Connect With Us</h3>
                        <div class="flex justify-center gap-4 flex-wrap">
                            <a href="https://www.facebook.com/codezelaca" target="_blank" 
                               class="w-12 h-12 rounded-xl bg-white/60 backdrop-blur-md border border-white/80 
                            ...
                            <a href="https://www.instagram.com/codezelaca" target="_blank"
                               class="w-12 h-12 rounded-xl bg-white/60 backdrop-blur-md border border-white/80 
                                      ...
                                      transition-all duration-300 hover:scale-110 group shadow-lg">
                                <svg class="w-6 h-6 text-pink-600 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="https://www.linkedin.com/company/codezelaca/" target="_blank"
                               class="w-12 h-12 rounded-xl bg-white/60 backdrop-blur-md border border-white/80 
                                      flex items-center justify-center hover:bg-blue-700 hover:border-blue-700 
                                      transition-all duration-300 hover:scale-110 group shadow-lg">
                                <svg class="w-6 h-6 text-blue-700 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                                </svg>
                            </a>
                            
                            <a href="https://x.com/codezelaca" target="_blank"
                               class="w-12 h-12 rounded-xl bg-white/60 backdrop-blur-md border border-white/80 
                                      flex items-center justify-center hover:bg-black hover:border-black 
                                      transition-all duration-300 hover:scale-110 group shadow-lg">
                                <svg class="w-5 h-5 text-gray-800 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                                </svg>
                            </a>
                            
                            <a href="https://tiktok.com/@codezelaca" target="_blank"
                               class="w-12 h-12 rounded-xl bg-white/60 backdrop-blur-md border border-white/80 
                                      flex items-center justify-center hover:bg-black hover:border-black 
                                      transition-all duration-300 hover:scale-110 group shadow-lg">
                                <svg class="w-6 h-6 text-gray-800 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Footer -->
            <footer class="relative z-10 px-6 lg:px-8 py-12 border-t border-white/20">
                <div class="max-w-7xl mx-auto">
                    <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                        <div class="flex items-center space-x-3">
                            <img src="{{ asset('images/icon.png') }}" alt="Codezela" class="w-8 h-8">
                            <div>
                                <span class="text-lg font-bold bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent block">
                                    Codezela Career Accelerator
                                </span>
                                <span class="text-xs text-gray-600">
                                    Powered by <a href="https://codezela.com" target="_blank" class="hover:text-primary-600 transition-colors font-medium">Codezela Technologies</a>
                                </span>
                            </div>
                        </div>
                        
                        <div class="text-center md:text-right text-sm text-gray-600">
                            <p>&copy; {{ date('Y') }} Codezela Career Accelerator. All rights reserved.</p>
                            <p class="mt-1">Built with ❤️ for aspiring professionals</p>
                        </div>
                    </div>
                </div>
            </footer>
        ...
        <script type="module">
            ...
            const createShape = (geometry, color, emissive, position, scale = 1) => {
            ...
            // Create stunning large geometric structures
            const shapes = [];
            ...
            shapes.push({ mesh: centerIco, rotSpeed: { x: 0.001, y: 0.002, z: 0.0005 } });
            scene.add(centerIco);
            ...
            shapes.push({ mesh: leftOcta, rotSpeed: { x: 0.0015, y: 0.001, z: 0.002 } });
            scene.add(leftOcta);
            ...
            shapes.push({ mesh: rightDodeca, rotSpeed: { x: 0.002, y: 0.0015, z: 0.001 } });
            ...
            shapes.push({ mesh: topTetra, rotSpeed: { x: 0.0012, y: 0.0018, z: 0.0008 } });
            scene.add(topTetra);
            ...
            shapes.push({ mesh: bottomTorus, rotSpeed: { x: 0.0008, y: 0.002, z: 0.0015 } });
            scene.add(bottomTorus);

            // Add wireframe versions for extra elegance
            ...
            function animate() {
                ...
                shapes.forEach((shape, index) => {
                    ...
                    shape.mesh.scale.setScalar(shape.mesh.scale.x > 0 ? breathe : breathe);
                    if (shape.wireMesh) {
        ...
        <style>
            ...
            /* Add a subtle gradient overlay for perfect text contrast */
            body::before {
                content: '';
                position: fixed;
                top: 0;
            ...
            /* Only add subtle shadow to buttons and links for depth */
            a, button {
                text-shadow: none;
            }
        </style>
        ...
        echo json_encode([
            ...
            'description' => 'Professional career development and tech training programs',
            'url' => url('/'),
            ...
            'sameAs' => [
                ...
                'https://tiktok.com/@codezelaca'
            ],
            'contactPoint' => [
                '@type' => 'ContactPoint',
                'telephone' => '+94-76-677-2923',
